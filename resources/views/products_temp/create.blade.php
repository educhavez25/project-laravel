...
{{-- 
                    ...
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="col-xxl-6 col-md-6">
                            <div>
                                ...
                                <textarea class="form-control" id="basiInput" name="description" placeholder="Ingrese la descripción"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="col-lg-12">
                            <button type="submit" type="button"
                                ...
                                <i class=" ri-save-3-fill label-icon align-middle fs-16 me-2"></i>
                                Guardar
                            </button>
                        </div>
                    </form>
    ...
    {{-- <form action="{{ route('products.store') }}" method="POST">
        ...
        <input type="text" name="price" placeholder="Ingrese el precio">
        <br><br>
        <label for="">Descripción:</label>
        <textarea name="description" placeholder="Ingrese la descripción"></textarea>
        <br><br>
